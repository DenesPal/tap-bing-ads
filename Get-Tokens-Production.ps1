Param(
   [Parameter(Mandatory,HelpMessage='Enter OAuth Client ID')]
   [string]$ClientId
)
$ErrorActionPreference = "Stop"

Write-Output "Visit the authorization URL, and authorize the app to your account:"
Write-Output "https://login.microsoftonline.com/common/oauth2/v2.0/authorize?client_id=$ClientId&scope=openid%20profile%20https://ads.microsoft.com/ads.manage%20offline_access&response_type=code&redirect_uri=https://login.microsoftonline.com/common/oauth2/nativeclient&state=ClientStateGoesHere&prompt=login"
